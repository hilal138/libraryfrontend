    ...
    <LibrarianLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-1">Library Books </h1>
            <p className="text-gray-500 text-sm">Manage and track inventory</p>
          </div>
          <button
            onClick={fetchBooks}
        ...
        {books.length === 0 ? (
          <div className="bg-white rounded-xl shadow-md p-12 text-center">
            ...
            <a 
              href="/librarian/add-book" 
              className="inline-flex items-center gap-2 mt-4 px-6 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition"
            >
              <Plus size={20} />
              Add Book
            </a>
